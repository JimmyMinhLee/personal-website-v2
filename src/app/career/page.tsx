...
export default function Page() {
  return (
    <Stack>
      ...
      <Flex direction="row">
        <CareerSection>
          <CareerYear>Software Engineer @ DoorDash (2022 → Current)</CareerYear>
        </CareerSection>
      </Flex>
      <UnorderedList>
        <ListItem>
        ...
        <ListItem>
          Responsible for most things related to code coverage @ DoorDash, built
          a dashboard for surfacing metrics, CI integrations for uploading to
          our vendor, and working alongside our vendor on scalability &
          reliability.
        </ListItem>
        <ListItem>
      ...
      <UnorderedList>
        ...
        <ListItem>
          Raised income of club from $1,000 in &apos;18-&apos;20 to over $10,000
          a semester.
        </ListItem>
        <ListItem>
          Retention rate increased from 35% to 82%, member satisfaction from 22%
          to 78%.
        </ListItem>
      </UnorderedList>
      <Flex direction="row">
      ...
      <Flex direction="row">
        <CareerSection>
          <CareerYear>Student Mentor @ Berkeley Anova (2019 → 2022)</CareerYear>
        </CareerSection>
      </Flex>
      <UnorderedList>
        <ListItem>
          Taught computer science to underresourced schools in the Oakland area.
        </ListItem>
      </UnorderedList>
    </Stack>
  );
